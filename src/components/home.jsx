...
<Box>
	...
	>
		...
		If you are having problems with ABC and would like to either find out your rights, whom to contact or make a complaint then use Resolver to make the process simpler. Connect via Resolver India's free online portal.
		</Typography>
		<Typography
			style={{
			marginBottom: 12,
			...
			variant="h4"
		>
			<i>Resolver is not affiliated to, linked with or otherwise endorsed by Flipkart.
		</i>
		</Typography>
		...
		<CardActions>
		<Button className="mx-auto"size="large" style={{textAlign:'center'}}>{ <Link
          to="/complaints/add"
